...
func mockClientWithVerifiableResults(t *testing.T, l log.Logger, n int, strictRounds bool) (client.Client, []mock.Result) {
	t.Helper()
...
func VerifyFuncTest(t *testing.T, clients, upTo int) {
	l := testlogger.New(t)
	c, results := mockClientWithVerifiableResults(t, l, clients, true)
