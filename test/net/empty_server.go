...
// ResurrectBeacon is an empty implementation
func (s *EmptyServer) ResurrectBeacon(context.Context, *drand.ResurrectBeaconRequest) (*drand.ResurrectBeaconResponse, error) {
	return nil, nil
}
