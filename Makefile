...
coverage:
	go get -v -t -d ./...
	go test -failfast -race -v -covermode=atomic -coverpkg ./... -coverprofile=coverage.txt ./...

coverage-postgres:
	go get -v -t -d ./...
	go test -failfast -race -v -tags=postgres -covermode=atomic -coverpkg ./... -coverprofile=coverage-postgres.txt ./...
