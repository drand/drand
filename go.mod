...
replace (
	// lru have introduced a breaking change in v2.0.3 breaking libp2p
	github.com/hashicorp/golang-lru/v2 => github.com/hashicorp/golang-lru/v2 v2.0.2
	// v0.3.0 is introducing breaking changes meant for the next release of quic-go
	github.com/quic-go/qtls-go1-20 => github.com/quic-go/qtls-go1-20 v0.2.2
	// v0.35.0 is introducing breaking changes not yet supported by go-libp2p
