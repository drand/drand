...
// NewRouter returns a new router from a given private key and a group
func NewRouter(priv *key.Private, list *key.Group) *Router {
...
// Listen opens a tcp port on the address taken in the public key
...
// Broadcast sends the same packet to the group
