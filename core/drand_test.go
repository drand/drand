...
func TestDrandLarge(t *testing.T) {
	testDrandLarge(t, false)
}
func TestDrandLargeDecoupled(t *testing.T) {
	testDrandLarge(t, true)
}

func testDrandLarge(t *testing.T, decouplePrevSig bool) {
	if testing.Short() {
...
func TestDrandDKGFresh(t *testing.T) {
	testDrandDKGFresh(t, false)
}
func TestDrandDKGFreshDecoupled(t *testing.T) {
	testDrandDKGFresh(t, true)
}
func testDrandDKGFresh(t *testing.T, decouplePrevSig bool) {
	n := 4
...
func TestDrandDKGBroadcastDeny(t *testing.T) {
	testDrandDKGBroadcastDeny(t, false)
}
func TestDrandDKGBroadcastDenyDecoupled(t *testing.T) {
	testDrandDKGBroadcastDeny(t, true)
}

func testDrandDKGBroadcastDeny(t *testing.T, decouplePrevSig bool) {
	n := 4
	thr := 3
	beaconPeriod := 1 * time.Second
...
func TestDrandReshareForce(t *testing.T) {
	testDrandReshareForce(t, false)
}
func TestDrandReshareForceDecoupled(t *testing.T) {
	testDrandReshareForce(t, true)
}

func testDrandReshareForce(t *testing.T, decouplePrevSig bool) {
	oldN := 4
	oldThr := 3
...
func TestDrandDKGReshareAbsent(t *testing.T) {
	testDrandDKGReshareAbsent(t, false)
}
func TestDrandDKGReshareAbsentDecoupled(t *testing.T) {
	testDrandDKGReshareAbsent(t, true)
}

func testDrandDKGReshareAbsent(t *testing.T, decouplePrevSig bool) {
	oldN := 3
	newN := 4
	oldThr := 2
	newThr := 3
...
func TestDrandDKGReshareTimeout(t *testing.T) {
	testDrandDKGReshareTimeout(t, false)
}
func TestDrandDKGReshareTimeoutDecoupled(t *testing.T) {
	testDrandDKGReshareTimeout(t, true)
}
func testDrandDKGReshareTimeout(t *testing.T, decouplePrevSig bool) {
	oldN := 3
	newN := 4
	oldThr := 2
	newThr := 3
...
func TestDrandResharePreempt(t *testing.T) {
	testDrandResharePreempt(t, false)
}
func TestDrandResharePreemptDecoupled(t *testing.T) {
	testDrandResharePreempt(t, true)
}

func testDrandResharePreempt(t *testing.T, decouplePrevSig bool) {
	if os.Getenv("CI") != "" {
...
func TestDrandPublicChainInfo(t *testing.T) {
	testDrandPublicChainInfo(t, false)
}
func TestDrandPublicChainInfoDecoupled(t *testing.T) {
	testDrandPublicChainInfo(t, true)
}

func testDrandPublicChainInfo(t *testing.T, decouplePrevSig bool) {
	n := 10
...
func TestDrandPublicRand(t *testing.T) {
	testDrandPublicRand(t, false)
}
func TestDrandPublicRandDecoupled(t *testing.T) {
	testDrandPublicRand(t, true)
}

// Test if the we can correctly fetch the rounds after a DKG using the
// PublicRand RPC call
func testDrandPublicRand(t *testing.T, decouplePrevSig bool) {
	n := 4
	thr := key.DefaultThreshold(n)
	p := 1 * time.Second
	dt := NewDrandTest2(t, n, thr, p, decouplePrevSig)
...
func TestDrandPublicStream(t *testing.T) {
	testDrandPublicStream(t, false)
}
func TestDrandPublicStreamDecoupled(t *testing.T) {
	testDrandPublicStream(t, true)
}
...
func testDrandPublicStream(t *testing.T, decouplePrevSig bool) {
	n := 4
	thr := key.DefaultThreshold(n)
	p := 1 * time.Second
	dt := NewDrandTest2(t, n, thr, p, decouplePrevSig)
...
func TestDrandFollowChain(tt *testing.T) {
	testDrandFollowChain(tt, false)
}
func TestDrandFollowChainDecoupled(tt *testing.T) {
	testDrandFollowChain(tt, true)
}

func testDrandFollowChain(tt *testing.T, decouplePrevSig bool) {
	n, p := 4, 1*time.Second
...
func TestDrandPublicStreamProxy(t *testing.T) {
	testDrandPublicStreamProxy(t, false)
}
func TestDrandPublicStreamProxyDecoupled(t *testing.T) {
	testDrandPublicStreamProxy(t, true)
}

// Test if the we can correctly fetch the rounds through the local proxy
func testDrandPublicStreamProxy(t *testing.T, decouplePrevSig bool) {
	n := 4
	thr := key.DefaultThreshold(n)
	p := 1 * time.Second
	dt := NewDrandTest2(t, n, thr, p, decouplePrevSig)
