...
//func ProtobufToKyberPoint(p *ProtobufPoint) (kyber.Point, error) {
...
//func KyberToProtobufPoint(p kyber.Point) (*ProtobufPoint, error) {
...
//func ProtobufToKyberScalar(p *ProtobufScalar) (kyber.Scalar, error) {
//groupName, exists := GroupID_name[int32(p.GetGid())]
//if !exists {
...
//func KyberToProtobufScalar(s kyber.Scalar) (*ProtobufScalar, error) {
