...
func (*PublicRandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_fc8d3a54ad9deaf8, []int{0}
}
...
func (*PublicRandResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_fc8d3a54ad9deaf8, []int{1}
}
...
func (*PrivateRandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_fc8d3a54ad9deaf8, []int{2}
}
...
func (*PrivateRandResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_fc8d3a54ad9deaf8, []int{3}
}
...
func (*ECIESObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_fc8d3a54ad9deaf8, []int{4}
}
...
func (*DistKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_fc8d3a54ad9deaf8, []int{5}
}
...
func (*DistKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_fc8d3a54ad9deaf8, []int{6}
}
...
// DistributedKeyClient is the client API for DistributedKey service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type DistributedKeyClient interface {
	DistKey(ctx context.Context, in *DistKeyRequest, opts ...grpc.CallOption) (*DistKeyResponse, error)
}

type distributedKeyClient struct {
	cc *grpc.ClientConn
}

func NewDistributedKeyClient(cc *grpc.ClientConn) DistributedKeyClient {
	return &distributedKeyClient{cc}
}

func (c *distributedKeyClient) DistKey(ctx context.Context, in *DistKeyRequest, opts ...grpc.CallOption) (*DistKeyResponse, error) {
	out := new(DistKeyResponse)
	err := c.cc.Invoke(ctx, "/drand.DistributedKey/DistKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// DistributedKeyServer is the server API for DistributedKey service.
type DistributedKeyServer interface {
	DistKey(context.Context, *DistKeyRequest) (*DistKeyResponse, error)
}

func RegisterDistributedKeyServer(s *grpc.Server, srv DistributedKeyServer) {
	s.RegisterService(&_DistributedKey_serviceDesc, srv)
}

func _DistributedKey_DistKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DistKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DistributedKeyServer).DistKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/drand.DistributedKey/DistKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DistributedKeyServer).DistKey(ctx, req.(*DistKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _DistributedKey_serviceDesc = grpc.ServiceDesc{
	ServiceName: "drand.DistributedKey",
	HandlerType: (*DistributedKeyServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DistKey",
			Handler:    _DistributedKey_DistKey_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "drand/client.proto",
...
func init() { proto.RegisterFile("drand/client.proto", fileDescriptor_client_fc8d3a54ad9deaf8) }

var fileDescriptor_client_fc8d3a54ad9deaf8 = []byte{
	// 473 bytes of a gzipped FileDescriptorProto
	,
}
