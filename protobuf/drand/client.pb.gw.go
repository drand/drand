...
func request_Info_Home_0(ctx context.Context, marshaler runtime.Marshaler, client InfoClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
var (
	pattern_Randomness_Public_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"public"}, ""))

	pattern_Randomness_Public_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"public", "round"}, ""))

	pattern_Randomness_Private_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"private"}, ""))
)
...
func RegisterInfoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InfoClient) error {
	...
	mux.Handle("GET", pattern_Info_Home_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Info_Home_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Info_DistKey_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"info", "dist_key"}, ""))

	pattern_Info_Home_0 = runtime.MustPattern(runtime.NewPattern(1, []int{1, 0}, []string(nil), ""))
)

var (
	forward_Info_DistKey_0 = runtime.ForwardResponseMessage

	forward_Info_Home_0 = runtime.ForwardResponseMessage
)
