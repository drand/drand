...
var file_drand_dkg_control_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x10, 0x0a, 0x0e,
	0x53, 0x74, 0x61, 0x72, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2e,
...
var file_drand_dkg_control_proto_depIdxs = []int32{
	...
	20, // 32: drand.DKGStatusResponse.complete:type_name -> drand.DKGEntry
	20, // 33: drand.DKGStatusResponse.current:type_name -> drand.DKGEntry
	22, // 34: drand.DKGEntry.timeout:type_name -> google.protobuf.Timestamp
	22, // 35: drand.DKGEntry.genesis_time:type_name -> google.protobuf.Timestamp
	22, // 36: drand.DKGEntry.transition_time:type_name -> google.protobuf.Timestamp
	13, // 37: drand.DKGEntry.leader:type_name -> drand.Participant
	13, // 38: drand.DKGEntry.remaining:type_name -> drand.Participant
	13, // 39: drand.DKGEntry.joining:type_name -> drand.Participant
	13, // 40: drand.DKGEntry.leaving:type_name -> drand.Participant
	13, // 41: drand.DKGEntry.acceptors:type_name -> drand.Participant
	13, // 42: drand.DKGEntry.rejectors:type_name -> drand.Participant
	23, // 43: drand.DKGPacket.dkg:type_name -> dkg.Packet
	1,  // 44: drand.DKGControl.Command:input_type -> drand.DKGCommand
	3,  // 45: drand.DKGControl.Packet:input_type -> drand.GossipPacket
	18, // 46: drand.DKGControl.DKGStatus:input_type -> drand.DKGStatusRequest
	21, // 47: drand.DKGControl.BroadcastDKG:input_type -> drand.DKGPacket
	0,  // 48: drand.DKGControl.Command:output_type -> drand.EmptyDKGResponse
	0,  // 49: drand.DKGControl.Packet:output_type -> drand.EmptyDKGResponse
	19, // 50: drand.DKGControl.DKGStatus:output_type -> drand.DKGStatusResponse
	0,  // 51: drand.DKGControl.BroadcastDKG:output_type -> drand.EmptyDKGResponse
