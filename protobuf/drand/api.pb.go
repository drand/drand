...
var file_drand_api_proto_rawDesc = []byte{
	...
	,
...
var file_drand_api_proto_goTypes = []interface{}{
	...
	(*ListBeaconIDsRequest)(nil),  // 4: drand.ListBeaconIDsRequest
	(*ListBeaconIDsResponse)(nil), // 5: drand.ListBeaconIDsResponse
...
var file_drand_api_proto_depIdxs = []int32{
	6,  // 0: drand.PublicRandRequest.metadata:type_name -> drand.Metadata
	6,  // 1: drand.PublicRandResponse.metadata:type_name -> drand.Metadata
	6,  // 2: drand.HomeRequest.metadata:type_name -> drand.Metadata
	6,  // 3: drand.HomeResponse.metadata:type_name -> drand.Metadata
	6,  // 4: drand.ListBeaconIDsResponse.metadata:type_name -> drand.Metadata
	...
	7,  // 7: drand.Public.ChainInfo:input_type -> drand.ChainInfoRequest
	2,  // 8: drand.Public.Home:input_type -> drand.HomeRequest
	4,  // 9: drand.Public.ListBeaconIDs:input_type -> drand.ListBeaconIDsRequest
	...
	8,  // 12: drand.Public.ChainInfo:output_type -> drand.ChainInfoPacket
	3,  // 13: drand.Public.Home:output_type -> drand.HomeResponse
	5,  // 14: drand.Public.ListBeaconIDs:output_type -> drand.ListBeaconIDsResponse
