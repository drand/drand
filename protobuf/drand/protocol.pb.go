...
var file_drand_protocol_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x32, 0x84, 0x03, 0x0a,
...
var file_drand_protocol_proto_depIdxs = []int32{
	...
	8,  // 11: drand.Protocol.GetIdentity:output_type -> drand.Identity
	11, // 12: drand.Protocol.SignalDKGParticipant:output_type -> drand.Empty
	11, // 13: drand.Protocol.PushDKGInfo:output_type -> drand.Empty
	11, // 14: drand.Protocol.FreshDKG:output_type -> drand.Empty
	11, // 15: drand.Protocol.ReshareDKG:output_type -> drand.Empty
	11, // 16: drand.Protocol.PartialBeacon:output_type -> drand.Empty
	7,  // 17: drand.Protocol.SyncChain:output_type -> drand.BeaconPacket
