...
var file_drand_control_proto_rawDesc = []byte{
	...
	0x6f, 0x77, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x9b, 0x04, 0x0a, 0x07,
...
var file_drand_control_proto_goTypes = []interface{}{
	...
	(*ChainInfoRequest)(nil),   // 18: drand.ChainInfoRequest
	(*GroupRequest)(nil),       // 19: drand.GroupRequest
	(*GroupPacket)(nil),        // 20: drand.GroupPacket
	(*ChainInfoPacket)(nil),    // 21: drand.ChainInfoPacket
}
var file_drand_control_proto_depIdxs = []int32{
	...
	18, // 10: drand.Control.ChainInfo:input_type -> drand.ChainInfoRequest
	19, // 11: drand.Control.GroupFile:input_type -> drand.GroupRequest
	16, // 12: drand.Control.Shutdown:input_type -> drand.ShutdownRequest
	8,  // 13: drand.Control.PingPong:output_type -> drand.Pong
	20, // 14: drand.Control.InitDKG:output_type -> drand.GroupPacket
	20, // 15: drand.Control.InitReshare:output_type -> drand.GroupPacket
	6,  // 16: drand.Control.Share:output_type -> drand.ShareResponse
	10, // 17: drand.Control.PublicKey:output_type -> drand.PublicKeyResponse
	12, // 18: drand.Control.PrivateKey:output_type -> drand.PrivateKeyResponse
	21, // 19: drand.Control.ChainInfo:output_type -> drand.ChainInfoPacket
	20, // 20: drand.Control.GroupFile:output_type -> drand.GroupPacket
	17, // 21: drand.Control.Shutdown:output_type -> drand.ShutdownResponse
