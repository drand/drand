...
var file_drand_control_proto_rawDesc = []byte{
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x41, 0x0a, 0x11, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65,
	...
	0x2c, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x32, 0x9e, 0x07,
...
var file_drand_control_proto_depIdxs = []int32{
	...
	2,  // 40: drand.Control.PingPong:output_type -> drand.Pong
	27, // 41: drand.Control.Status:output_type -> drand.StatusResponse
	6,  // 42: drand.Control.ListSchemes:output_type -> drand.ListSchemesResponse
	8,  // 43: drand.Control.ListBeaconIDs:output_type -> drand.ListBeaconIDsResponse
	10, // 44: drand.Control.PublicKey:output_type -> drand.PublicKeyResponse
	12, // 45: drand.Control.PrivateKey:output_type -> drand.PrivateKeyResponse
	31, // 46: drand.Control.ChainInfo:output_type -> drand.ChainInfoPacket
	32, // 47: drand.Control.GroupFile:output_type -> drand.GroupPacket
	17, // 48: drand.Control.Shutdown:output_type -> drand.ShutdownResponse
	19, // 49: drand.Control.LoadBeacon:output_type -> drand.LoadBeaconResponse
	21, // 50: drand.Control.StartFollowChain:output_type -> drand.SyncProgress
	21, // 51: drand.Control.StartCheckChain:output_type -> drand.SyncProgress
	23, // 52: drand.Control.BackupDatabase:output_type -> drand.BackupDBResponse
	4,  // 53: drand.Control.RemoteStatus:output_type -> drand.RemoteStatusResponse
