...
func (x *RemoteStatusRequest) GetAddresses() []string {
	if x != nil {
		return x.Addresses
	}
	return nil
...
var file_drand_control_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x61, 0x0a, 0x13, 0x52, 0x65, 0x6d, 0x6f,
...
var file_drand_control_proto_goTypes = []interface{}{
	...
	(*ChainInfoPacket)(nil),       // 34: drand.ChainInfoPacket
}
var file_drand_control_proto_depIdxs = []int32{
	...
	27, // 14: drand.RemoteStatusResponse.statuses:type_name -> drand.RemoteStatusResponse.StatusesEntry
	28, // 15: drand.ListSchemesRequest.metadata:type_name -> common.Metadata
	28, // 16: drand.ListSchemesResponse.metadata:type_name -> common.Metadata
	28, // 17: drand.PublicKeyRequest.metadata:type_name -> common.Metadata
	28, // 18: drand.PublicKeyResponse.metadata:type_name -> common.Metadata
	28, // 19: drand.PrivateKeyRequest.metadata:type_name -> common.Metadata
	28, // 20: drand.PrivateKeyResponse.metadata:type_name -> common.Metadata
	28, // 21: drand.CokeyRequest.metadata:type_name -> common.Metadata
	28, // 22: drand.CokeyResponse.metadata:type_name -> common.Metadata
	28, // 23: drand.GroupTOMLResponse.metadata:type_name -> common.Metadata
	28, // 24: drand.ShutdownRequest.metadata:type_name -> common.Metadata
	28, // 25: drand.ShutdownResponse.metadata:type_name -> common.Metadata
	28, // 26: drand.StartFollowRequest.metadata:type_name -> common.Metadata
	28, // 27: drand.FollowProgress.metadata:type_name -> common.Metadata
	28, // 28: drand.BackupDBRequest.metadata:type_name -> common.Metadata
	28, // 29: drand.BackupDBResponse.metadata:type_name -> common.Metadata
	29, // 30: drand.RemoteStatusResponse.StatusesEntry.value:type_name -> drand.StatusResponse
	8,  // 31: drand.Control.PingPong:input_type -> drand.Ping
	30, // 32: drand.Control.Status:input_type -> drand.StatusRequest
	12, // 33: drand.Control.ListSchemes:input_type -> drand.ListSchemesRequest
	1,  // 34: drand.Control.InitDKG:input_type -> drand.InitDKGPacket
	4,  // 35: drand.Control.InitReshare:input_type -> drand.InitResharePacket
	6,  // 36: drand.Control.Share:input_type -> drand.ShareRequest
	14, // 37: drand.Control.PublicKey:input_type -> drand.PublicKeyRequest
	16, // 38: drand.Control.PrivateKey:input_type -> drand.PrivateKeyRequest
	31, // 39: drand.Control.ChainInfo:input_type -> drand.ChainInfoRequest
	32, // 40: drand.Control.GroupFile:input_type -> drand.GroupRequest
	21, // 41: drand.Control.Shutdown:input_type -> drand.ShutdownRequest
	23, // 42: drand.Control.StartFollowChain:input_type -> drand.StartFollowRequest
	25, // 43: drand.Control.BackupDatabase:input_type -> drand.BackupDBRequest
	10, // 44: drand.Control.RemoteStatus:input_type -> drand.RemoteStatusRequest
	9,  // 45: drand.Control.PingPong:output_type -> drand.Pong
	29, // 46: drand.Control.Status:output_type -> drand.StatusResponse
	13, // 47: drand.Control.ListSchemes:output_type -> drand.ListSchemesResponse
	33, // 48: drand.Control.InitDKG:output_type -> drand.GroupPacket
	33, // 49: drand.Control.InitReshare:output_type -> drand.GroupPacket
	7,  // 50: drand.Control.Share:output_type -> drand.ShareResponse
	15, // 51: drand.Control.PublicKey:output_type -> drand.PublicKeyResponse
	17, // 52: drand.Control.PrivateKey:output_type -> drand.PrivateKeyResponse
	34, // 53: drand.Control.ChainInfo:output_type -> drand.ChainInfoPacket
	33, // 54: drand.Control.GroupFile:output_type -> drand.GroupPacket
	22, // 55: drand.Control.Shutdown:output_type -> drand.ShutdownResponse
	24, // 56: drand.Control.StartFollowChain:output_type -> drand.FollowProgress
	26, // 57: drand.Control.BackupDatabase:output_type -> drand.BackupDBResponse
	11, // 58: drand.Control.RemoteStatus:output_type -> drand.RemoteStatusResponse
