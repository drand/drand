...
func (*BeaconRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_beacon_5f3cb5ca9fecddb4, []int{0}
}
...
func (*BeaconResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_beacon_5f3cb5ca9fecddb4, []int{1}
}
...
func init() { proto.RegisterFile("drand/beacon.proto", fileDescriptor_beacon_5f3cb5ca9fecddb4) }

var fileDescriptor_beacon_5f3cb5ca9fecddb4 = []byte{
