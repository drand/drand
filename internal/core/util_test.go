...
//nolint:funlen
func (d *DrandTestScenario) RunReshareWithHooks(t *testing.T, remainingNodes []*MockNode, joiningNodes []*MockNode, threshold int, hooks lifecycleHooks) (*key.Group, error) {
