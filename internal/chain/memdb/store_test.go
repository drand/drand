...
func TestStore_Put(t *testing.T) {
	...
	genBeacons := func(size int) []common.Beacon {
		result := make([]common.Beacon, size)
		for i := 0; i < size; i++ {
			result[i] = common.Beacon{
	...
	shuffle := func(size int) []common.Beacon {
